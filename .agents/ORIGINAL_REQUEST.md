...
### R2. Tactile Digital Brutalist UI (Qt 6 / QML or Modern Native GUI)
...
- Persist playlist queue, volume level, recent playback history, and window geometry across sessions in a local config/database.
